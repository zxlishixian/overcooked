"""Belief-conditioned Actor-Critic for Belief-PPO.

Input: [obs (obs_dim) || belief (belief_dim)]
Separate actor/critic MLP trunks, orthogonal initialization.
"""
import numpy as np
import torch
...
class BeliefActorCritic(nn.Module):
    """Standard actor-critic conditioned on belief state.
    ...
    def __init__(self, obs_dim, belief_dim=32, hidden_dim=256,
